					...
					{songs.map((song, index) => {
						...
						return (
							<button
								...
								className={cn(
									"w-full grid grid-cols-[auto_1fr_auto] gap-4 px-4 py-3 hover:bg-muted/50 transition-colors group cursor-pointer text-left",
							...
							>
								...
								<span
									className={cn(
										"w-8 text-center hidden items-center justify-center",
										!isCurrentTrack && "group-hover:flex",
									)}
								>
